...
@customElement('arrows-page')
export class ArrowsPage extends LitElement {
  render() {
    return html`
      <div class="page">
        <div class="container">
          <nav-bar current="arrows"></nav-bar>
          <h1>Arrows Extension Test Page</h1>
          <p class="subtitle">Test suite for the Arrows extension (navigation arrows)</p>
          ...
          <section>
            <h2>Auto-hide Arrows (when at start/end)</h2>
            <motionrail-element
              .options=${{
                breakpoints: [
                  { columns: 1, gap: '16px' },
