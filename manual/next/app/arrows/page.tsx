  ...
  return (
    <div style={{ padding: '40px', background: '#000', color: '#eaeaea', minHeight: '100vh' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <section style={{ marginBottom: '60px' }}>
          <h2 style={{ marginBottom: '15px', fontSize: '18px' }}>Arrows with Loop Disabled</h2>
          <MotionRail
            options={{
              breakpoints: [
                { columns: 1, gap: '16px' },
        ...
        {/* Edge Case: Not Enough Items (Single Item) */}
        <section style={{ marginBottom: '60px' }}>
          <h2 style={{ marginBottom: '15px', fontSize: '18px' }}>
            Edge Case: Single Item (arrows should be hidden)
          </h2>
          <MotionRail
            options={{
              breakpoints: [
