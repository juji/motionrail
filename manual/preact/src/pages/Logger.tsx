...
export default function LoggerPage({ path: _path }: { path?: string }) {
  return (
    <div style={{ padding: '40px', background: '#000', color: '#eaeaea', minHeight: '100vh' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <Nav current="logger" />
        <h1 style={{ marginBottom: '10px' }}>Logger Extension Test Page</h1>
        <p style={{ marginBottom: '30px', color: '#999', fontSize: '14px' }}>
          Test suite for the Logger extension (check browser console for logs)
        </p>
